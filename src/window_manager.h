...
struct VirtualWindow* window_manager_window_new(int width, int height); // DEPRECATED
void window_manager_window_release(struct VirtualWindow* window); // DEPRECATED
void window_manager_window_release_all(void); // DEPRECATED
void window_manager_window_draw(struct VirtualWindow* window);
void window_manager_window_clear(struct VirtualWindow* window); // DEPRECATED
void window_manager_window_fill_character(struct VirtualWindow* window, chtype character); // DEPRECATED
void window_manager_window_set_pixel(struct VirtualWindow* window, int x, int y, struct VirtualPixel pixel); // DEPRECATED
...
struct VirtualWindow* window_manager_window_setup_from_sprite(const struct Sprite* sprite); // DEPRECATED
struct VirtualWindow* window_manager_window_set_sprite(struct VirtualWindow* window, const struct Sprite* sprite); // DEPRECATED
...
void window_manager_window_scroll_down(struct VirtualWindow* window); // DEPRECATED
