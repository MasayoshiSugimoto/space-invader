...
void virtual_cursor_2_test() {
    ...
    struct VirtualCursor cursor_0;
    virtual_cursor_init(&cursor_0, &sprite_buffer_0);
    virtual_cursor_text_print(&cursor_0, "TESTING VIRTUAL CURSOR");
    virtual_cursor_new_line(&cursor_0);
    virtual_cursor_text_print(&cursor_0, "======================");
    virtual_cursor_new_line(&cursor_0);
    virtual_cursor_text_print(&cursor_0, "Will populate windows with different styling.");
    ...
    struct VirtualCursor cursor_1;
    virtual_cursor_init(&cursor_1, &sprite_buffer_1);
    virtual_cursor_text_print(&cursor_1, "BIG STRING");
    virtual_cursor_new_line(&cursor_1);
    virtual_cursor_text_print(&cursor_1, "==========");
    virtual_cursor_new_line(&cursor_1);
    _random_string(_buf, BUFFER_LENGTH - 1);
    virtual_cursor_text_print(&cursor_1, _buf);
    ...
    struct VirtualCursor cursor_2;
    virtual_cursor_init(&cursor_2, &sprite_buffer_2);
    virtual_cursor_text_center_x(&cursor_2, "CENTERED STRING");
    virtual_cursor_text_print(&cursor_2, "CENTERED STRING");
    virtual_cursor_new_line(&cursor_2);
    virtual_cursor_text_center_x(&cursor_2, "===============");
    virtual_cursor_text_print(&cursor_2, "===============");
    virtual_cursor_new_line(&cursor_2);
    _random_string(_buf, 10);
    virtual_cursor_text_center_x(&cursor_2, _buf);
    virtual_cursor_text_print(&cursor_2, _buf);
    virtual_cursor_new_line(&cursor_2);
    ...
    struct VirtualCursor cursor_3;
    virtual_cursor_init(&cursor_3, &sprite_buffer_3);
    virtual_cursor_text_align_right(&cursor_3, "RIGHT STRING");
    virtual_cursor_text_print(&cursor_3, "RIGHT STRING");
    virtual_cursor_new_line(&cursor_3);
    virtual_cursor_text_align_right(&cursor_3, "=============");
    virtual_cursor_text_print(&cursor_3, "=============");
    virtual_cursor_new_line(&cursor_3);
    _random_string(_buf, 10);
    virtual_cursor_text_align_right(&cursor_3, _buf);
    virtual_cursor_text_print(&cursor_3, _buf);
    virtual_cursor_new_line(&cursor_3);
    _random_string(_buf, 15);
    virtual_cursor_text_align_right(&cursor_3, _buf);
    virtual_cursor_text_print(&cursor_3, _buf);
